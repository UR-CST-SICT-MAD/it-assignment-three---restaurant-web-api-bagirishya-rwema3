...
if ($conn->connect_error)
 ...
 if(isset($_POST['search'])){
	 ...
	 $sql = "SELECT * FROM restaurants WHERE location LIKE '%$searchq%' OR rating like '%$searchq%' ";
	 ...
	 if ($count->num_rows > 0){
		...
		while($row = $count->fetch_array()) {
			...
			$output .= '<div>'.$restaurant_name.' '.$location.'<div>';
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">The</span> available Restaurants
						 <?php
 
 $quer="SELECT * FROM restaurants";
...
<tr> <th>Restaurant_Id</th><th>Restaurant_Name</th> <th>owner</th> <th>Rating</th> <th>location</th><th>View Dishes  Here</th> </tr>


<?php

$query1= "SELECT restaurant_id, restaurant_name, owner, rating, location  FROM restaurants";
...
echo "<td><a href='dish.php?restaurant_id=".$row['restaurant_id']."'><img  src='here.gif' width='60' height='25'/>Here</a></td>";
